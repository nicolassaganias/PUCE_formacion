/*
  DATALOGGER MULTISENSOR (Arduino UNO) - MINIMAL, sin delay() en loop, LCD sin titileo (diff update)
...
const uint32_t LOG_INTERVAL_MS    = 60000;
...
// ------------------- Scheduler -------------------
uint32_t tSensor = 0, tLog = 0, tPage = 0, tLcd = 0;
uint8_t page = 0;
